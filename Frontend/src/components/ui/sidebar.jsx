...
function SidebarHeader({
  ...
  return (
    <div
      ...
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-2 group-data-[collapsible=icon]:p-2 group-data-[collapsible=icon]:items-center group-data-[collapsible=icon]:justify-center [--radius:var(--radius-xl)]", className)}
      {...props} />
  );
}
...
function SidebarFooter({
  ...
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn("flex flex-col gap-2 p-2 group-data-[collapsible=icon]:p-2 group-data-[collapsible=icon]:items-center group-data-[collapsible=icon]:justify-center", className)}
      {...props} />
  );
}
...
function SidebarContent({
  ...
  return (
    <div
      ...
      className={cn(
        "no-scrollbar flex min-h-0 flex-1 flex-col gap-2 overflow-auto [--radius:var(--radius-xl)] group-data-[collapsible=icon]:overflow-hidden group-data-[collapsible=icon]:items-center group-data-[collapsible=icon]:px-0",
        className
      )}
      {...props} />
  );
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-xl px-3 py-2 text-left text-sm whitespace-nowrap ring-sidebar-ring outline-hidden transition-[width,height,padding] duration-200 group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-0! group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:has-[>svg:first-child]:p-0! group-data-[collapsible=icon]:has-[>svg:last-child]:p-0! hover:bg-muted/60 hover:text-foreground focus-visible:ring-3 active:bg-muted/70 disabled:pointer-events-none disabled:opacity-50 has-[>svg:first-child]:pl-2.5 has-[>svg:last-child]:pr-2.5 aria-disabled:pointer-events-none aria-disabled:opacity-50 aria-expanded:hover:bg-muted/60 data-open:hover:bg-muted/60 data-active:bg-primary/15 data-active:font-semibold data-active:text-primary data-active:border data-active:border-primary/20 data-active:shadow-xs [&_svg]:size-4 [&_svg]:shrink-0 [&>span:last-child]:truncate",
  {
    variants: {
      variant: {
