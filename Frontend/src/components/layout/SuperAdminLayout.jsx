...
import { SmtpConfigModal } from "@/components/super-admin/SmtpConfigModal"
...
export function SuperAdminLayout() {
  ...
  const { data: smtpConfig } = useQuery({
    queryKey: ["superAdminSmtpConfig"],
    queryFn: superAdminService.getSmtpConfig,
    staleTime: 30 * 1000,
  })
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-background text-foreground">
      ...
      {/* Super Admin SMTP Configuration Modal */}
      <SmtpConfigModal
